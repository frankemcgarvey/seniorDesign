...
def sin_decay_gcc(delay):
    ...
    decay_gcc_j_i           = gcc_phat(decay_j, decay_i, 512)
    decay_noise_gcc_j_i     = gcc_phat(decay_noise_j, decay_noise_i, 512)
    decay_filter_gcc_j_i    = gcc_phat(decay_filter_j, decay_filter_i, 512)
